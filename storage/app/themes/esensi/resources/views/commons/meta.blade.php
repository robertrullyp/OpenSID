@php
    ...
    $canonicalUrl = isset($single_artikel) ? ($single_artikel['url_slug'] ?? current_url()) : current_url();
@endphp
...
<link rel="alternate" type="application/rss+xml" title="Feed {{ $nama_desa }}" href="{{ site_url('feed.xml') }}" />
